            ...
            <div class="navbar-nav">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="empprofile.php" class="dropdown-item">VIEW</a>
                        <a href="eedit.php" class="dropdown-item">EDIT</a>
                        
                    </div>
                </div>
                 <a href="eprofit.php" class="nav-item nav-link active"><i class="fa fa-line-chart" aria-hidden="true"></i> 
		TURN OVER</a>
                ...
                CUSTOMER</a>
                    <div class="dropdown-menu">
                       <a href="ecsearch.php" class="dropdown-item">SEARCH</a>
                        <a href="ecsearch.php" class="dropdown-item">DETAILS</a>
               ...
               <a href="eaddc.php" class="nav-item nav-link active"><i class="fa fa-user-circle-o" aria-hidden="true"></i>
                     ADD EMPLOYEE</a>
                <a href="edeletec.php" class="nav-item nav-link active"><i class="fa fa-user-circle-o" aria-hidden="true"></i>
                     DEL EMPLOYEE</a>
                 ...
                 <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                       <a href="carshroom.html" class="dropdown-item">YES</a>
                        <a href="employeview.php" class="dropdown-item">NO</a>
